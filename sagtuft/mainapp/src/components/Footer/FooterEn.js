    ...
    render() {
        return (
            <footer className={this.props.main_content_show ? 'footer' : 'footer footer_hidden'}>
                ...
                <div className="footer__col">
                    <div className="footer__menu-block">
                        <p className="footer__menu-title">Information</p>
                        <a href="" className="footer__menu-link">Our addresses</a>
                        <a href="" className="footer__menu-link">Blogs</a>
                        <a href="" className="footer__menu-link">About</a>
                        <a href="" className="footer__menu-link">FAQ</a>
                        <a href="" className="footer__menu-link">Terms of use</a>
                        <a href="" className="footer__menu-link">Job vacancy</a>
                        <a href="" className="footer__menu-link">Stadium address</a>
                    </div>
                </div>
                <div className="footer__col">
                    <div className="footer__menu-block">
                        <p className="footer__menu-title">Catalog</p>
                        <a href="" className="footer__menu-link">Carpet</a>
                        <a href="" className="footer__menu-link">Artificial turf</a>
                        <a href="" className="footer__menu-link">Velveteen</a>
                        <a href="" className="footer__menu-link">Thread</a>
                    </div>
                </div>
            </footer>
        );
