            ...
            <footer className={this.props.main_content_show ? 'footer' : 'footer footer_hidden'}>
                ...
                <div className="footer__col">
                    <div className="footer__menu-block">
                        ...
                        <a href="" className="footer__menu-link">Gilam</a>
                        <a href="" className="footer__menu-link">Sun'iy çim</a>
                        <a href="" className="footer__menu-link">Velvetin</a>
                        <a href="" className="footer__menu-link">Ip</a>
                    </div>
                </div>
            </footer>
        );
